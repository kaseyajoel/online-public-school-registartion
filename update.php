...
<?php
 ...
 $q = " update studenttable set stdid=$stdid, studentfname='$studentfname', studentlname='$studentlname',class='$class',age='$age',address='$address',parentphone='$parentphone',nationality='$nationality' where stdid=$stdid ";
