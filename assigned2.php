...
<div class="row mt-5"><!--ici ce pour laisser l'espace entre navbar et le form si tu ecrit -6 ce pour ke le form soit atacher au navbar---------------->
  ...
  <div class="col-md-6 m-auto">
    ...
    <h1 class="text-center" style=" padding:10px; border-radius:10px; background-color:#ff8080;color:#fff;">Register Commune of Karisimbi </h1>
...
$insert=mysqli_query($db,"INSERT INTO Assigned2(studentfname,studentlname, class,school,age,  address,parentphone,nationality,sexe)
