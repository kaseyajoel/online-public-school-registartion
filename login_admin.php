...
<?php 
	include"body/navadmin.php";//end if isset log in
 ?>
 <head>
...
<div class="row mt-5">
	<div class="col-md-6 m-auto">
		<div class="card card-body">
			...
			<form method="POST" action="loginconAdmin.php">
				...
				<div class="form-group">
					<button type="submit" class="col-md-12 btn btn-success" name="login">Submit</button>
				</div>
			</form>
		</div>
	</div>
